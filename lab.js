...
function totalPopulation (objects){
  let {utah,california,texas,arizona}= objects 
...
user.email = 'bryan.smith@devmountaina.in'
...
const ron = new Wizard ('ron', 22 , 'studying') 
ron.castSpell() 
